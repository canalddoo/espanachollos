          ...
          <div className="info-status-card">
            <div className="info-item">
              ...
              <div className="info-text">
                <h3>Teléfono</h3>
                <a href="tel:+34727745478" className="info-link">
                  +34 727 745 478
                </a>
            ...
            <div className="info-item">
              ...
              <div className="info-text">
                ...
                <a href="mailto:contact@espanachollos.es" className="info-link">
                  contact@espanachollos.es
                </a>
            ...
            <div className="info-item">
              ...
              <div className="info-text">
                ...
                <p className="info-cif"><strong>CIF / NIF:</strong> B-88765432</p>
              </div>
            </div>
