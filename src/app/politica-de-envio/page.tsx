export default function PoliticaEnvio() {
  return (
    ...
    >
      ...
      <p>
        <strong>ESPANA CHOLLOS</strong> realiza envíos a toda España peninsular e
      ...
      <p>
        ...
        afectados por circunstancias ajenas a ESPANA CHOLLOS, como incidencias
      ...
      <p>
        ...
        <strong>contact@espanachollos.es</strong> para que podamos gestionar la
        incidencia.
      </p>
